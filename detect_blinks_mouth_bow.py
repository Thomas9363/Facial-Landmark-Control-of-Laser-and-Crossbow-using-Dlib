...
PAN_CHANNEL,TILT_CHANNEL, BOW_CHANNEL, LASER_CHANNEL  = 0, 1, 14, 15 # Channel 0 for servo control
pan_initial_angle=110.0 # Set initial angles for servos
tilt_initial_angle=110.0 
bow_initial_angle=50.0
...
kit.servo[BOW_CHANNEL].angle = bow_initial_angle # Move servos to initial angles
...
#         cv2.drawContours(frame, [mouthHull], -1, (0, 255, 255), 1)
    ...
    pTime = cTime
    cv2.putText(frame, f"FPS : {int(fps)}", (10, 15), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)     
...
kit.servo[14].angle = bow_initial_angle 
